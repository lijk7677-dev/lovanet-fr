      ...
      <div className="relative overflow-hidden" data-testid="root-landing-page">
        ...
        <section className="mx-auto w-[95%] md:w-[50%] lg:w-[28%] px-4 pb-12 pt-8 sm:px-6 sm:pb-16 sm:pt-12 lg:px-8 lg:pb-24 lg:pt-20">
          <div className={`${luxurySection} p-2 sm:p-3 lg:p-4`}>
            ...
            <div
              ref={bannerShellRef}
              className="hero-banner-3d relative overflow-hidden rounded-[1.25rem] min-h-[350px] sm:min-h-[440px] lg:min-h-[300px] w-full"
            ...
            >
              ...
              <div className="hero-banner-content relative flex min-h-[350px] sm:min-h-[440px] lg:min-h-[300px] flex-col justify-end p-4 sm:p-6 lg:p-8 z-30 pointer-events-none">
